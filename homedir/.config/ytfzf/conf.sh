...
##(YTFZF_PREF)
#video_pref="22"
## 249   webm  audio only tiny   51k , webm_dash container, opus @ 51k (48000Hz), 4.42MiB
## 250   webm  audio only tiny   66k , webm_dash container, opus @ 66k (48000Hz), 5.78MiB
## 251   webm  audio only tiny  125k , webm_dash container, opus @125k (48000Hz), 10.88MiB
## 140   m4a   audio only tiny  129k , m4a_dash container, mp4a.40.2@129k (44100Hz), 11.22MiB
## 18    mp4   640x360    360p  133k , avc1.42001E, 30fps, mp4a.40.2 (44100Hz), 11.60MiB
## 22    mp4   1280x720   720p  162k , avc1.64001F, 30fps, mp4a.40.2 (44100Hz) (best)
...
#shortcuts="alt-u,alt-t,alt-e,alt-v,alt-d,alt-m,alt-s,alt-enter"
